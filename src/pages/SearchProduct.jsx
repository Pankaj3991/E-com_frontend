...
const SearchProduct = () => {
  ...
  return (
    <div className="mt-[7vh] min-h-[100vh] pt-[5vh]">
      {products.length == 0 && (
        <div className="w-[100vw] h-[90vh] flex flex-col justify-center items-center">
          <div className="text-xl">No product found related to {keyword}</div>
      ...
      <div className="flex flex-wrap gap-[5vw] justify-evenly mb-[5vh]">
        {products?.map((product) => (
          <div
            key={product._id}
            className="flex flex-col w-[70vw] md:w-[40vw] lg:w-[25vw] border border-textAndBorder hover:shadow-black hover:shadow-lg cursor-pointer rounded-lg py-[2vh]"
            onClick={() => {
