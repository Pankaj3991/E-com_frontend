...
const Listing = () => {
  ...
  return (
    <div className="mt-[7vh] min-h-[100vh]">
      <div className="text-xl md:text-2xl lg:text-4xl font-bold mb-[5vh] mt-[10vh] ml-[5vw]">Explore products</div>
      <div className="flex flex-wrap gap-[5vw] justify-evenly mb-[5vh]">
        {products?.map((product) => (
          <div
            key={product._id}
            className="flex flex-col w-[70vw] md:w-[40vw] lg:w-[25vw] border border-textAndBorder hover:shadow-textAndBorder hover:shadow-lg cursor-pointer rounded-lg pb-4"
      ...
      <div className="flex justify-center mb-[5vh]">
        <button
          className="px-3 py-1 mx-1 bg-grayColor hover:shadow-lg cursor-pointer rounded"
